defmodule CritWeb.Admin.UserControllerTest do
  ...
  @create_attrs %{active: true, email: "some email", name: "some name", password_hash: "some password_hash"}
  @update_attrs %{active: false, email: "some updated email", name: "some updated name", password_hash: "some updated password_hash"}
  @invalid_attrs %{active: nil, email: nil, name: nil, password_hash: nil}
