defmodule CritWeb.Templates.Purpose do

  # See `mix new_purpose`
  def create_a_password_without_needing_an_existing_one, 
    do: "create a password without needing an existing one"
  ...
  def snippet_to_display_procedure, 
    do: "snippet to display procedure"

  def public_facing_page, 
    do: "public facing page"

  def after_the_fact_pick_context, 
